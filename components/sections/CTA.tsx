...
export default function CTA() {
  return (
    <section className="relative border-t border-violet-200 overflow-hidden bg-white/70">
      {/* richer background */}
      <div className="absolute inset-0">
        <div className="absolute inset-0 bg-white/70" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_25%,rgba(109,94,252,0.18),transparent_58%),radial-gradient(circle_at_75%_75%,rgba(59,130,246,0.14),transparent_62%)]" />
        ...
        <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_50%_10%,transparent_35%,rgba(255,255,255,0.58)_92%)]" />
        {/* grain */}
        <div
      ...
      <Container className="relative z-10 py-16 sm:py-20">
        ...
        <div className="flex items-end justify-between gap-8 flex-wrap">
          <div className="max-w-2xl">
            <Badge>START</Badge>
            <h2 className="mt-4 text-3xl sm:text-5xl font-semibold tracking-[-0.04em] text-slate-900">
        ...
        <div className="mt-10 grid gap-4 md:grid-cols-3">
          {[
            ...
            <div
              key={x.k}
              className="rounded-2xl border border-violet-200 bg-violet-50 px-5 py-4"
        ...
        {/* subtle closing line */}
        <div className="mt-4 flex flex-wrap gap-x-10 gap-y-2 text-xs text-slate-400">
